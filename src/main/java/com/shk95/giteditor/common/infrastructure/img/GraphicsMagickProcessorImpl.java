package com.shk95.giteditor.common.infrastructure.img;

import com.shk95.giteditor.common.service.img.ImageProcessor;
...
@Slf4j
@Component
public class GraphicsMagickProcessorImpl implements ImageProcessor {

	private final String commandSearchPath;

	public GraphicsMagickProcessorImpl(ApplicationProperties properties) {
