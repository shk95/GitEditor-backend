...
public class SignupOAuthCommand {
	...
	//	private String defaultUserId; 삭제
	...
	public SignupOAuthCommand setSignupInfo(AuthRequest.Signup.OAuth userInfo) {
//		this.setDefaultUserId(userInfo.getUserId());
		this.setDefaultUsername(userInfo.getUsername());
		return this;
	}

	public SignupOAuthCommand setProviderLoginInfo(ProviderLoginInfo userInfo) {
