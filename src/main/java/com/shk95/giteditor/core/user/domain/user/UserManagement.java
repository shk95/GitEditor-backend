...
import com.shk95.giteditor.common.file.FileStorage;
import com.shk95.giteditor.common.file.FileStorageResolver;
import com.shk95.giteditor.common.file.FileUrlCreator;
import com.shk95.giteditor.common.file.TempFile;
import com.shk95.giteditor.common.img.ThumbnailCreator;
import com.shk95.giteditor.common.mail.MailManager;
import com.shk95.giteditor.common.mail.MessageVariable;
...
import com.shk95.giteditor.core.user.adapter.out.GptAdapter;
...
public class UserManagement {
	...
	public boolean updateOpenAIService(UpdateOpenAIServiceCommand command) {
		if (!verifyOpenAI(command.accessToken())) {
			return false;
		}
		return userRepository.findById(UserId.of(command.userId()))
			.map(user -> {
	...
	private boolean verifyOpenAI(String apiKey) {
		return gptAdapter.isAvailable(apiKey);
	}
}
